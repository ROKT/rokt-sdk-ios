...
//                        parentGuid: "f5987bb9-f7ba-4a89-91e7-80a446c5d29c"))).toEventually(beTrue(), timeout: .seconds(2))
                    ...
                    if let placementReadyInfo = partnerEventsInfo["PlacementReady"] as? RoktEvent.PlacementReady {
                        expect(placementReadyInfo.identifier).toEventually(equal("2732370593714667533"))
                    }
                    ...
                    if let placementInteractiveInfo = partnerEventsInfo["PlacementInteractive"] as? RoktEvent
                        ...
                        expect(placementInteractiveInfo.identifier).toEventually(equal("2732370593714667533"))
                    }
                }
...
//        describe("Rokt embedded bounding box tests") {
...
//            context("Layout hidden tests", {
//
//                beforeEach {
//                    errors = []
//                    testVC = TestViewController()
//                    testVC.hideLocation1 = true
//
//                    UIApplication.shared.keyWindow!.rootViewController = testVC
//                    _ = testVC.view
//
//                }
//
//                it("layout_hidden diagnostic sent") {
//                    expect(testVC.embeddedLocation1?.isHidden).toEventually(beTrue(), timeout: .seconds(2))
//                    expect(errors.contains("[LAYOUT_HIDDEN]")).toEventually(beTrue(), timeout: .seconds(9))
//                }
//            })
//
//            context("Layout missized tests", {
//
//                beforeEach {
//                    errors = []
//                    testVC = TestViewController()
//                    testVC.attachLocation1 = false
//
//                    UIApplication.shared.keyWindow!.rootViewController = testVC
//                    _ = testVC.view
//
//                }
//
//                it("layout is not attached to the screen") {
//                    expect(errors.contains("[LAYOUT_MISSIZED]")).toEventually(beTrue(), timeout: .seconds(9))
//                }
//            })
//
//            context("Layout cutoff tests", {
//
//                beforeEach {
//                    errors = []
//                    testVC = TestViewController()
//                    testVC.cutOffParentSize = CGSize(width: 50, height: 50)
//
//                    UIApplication.shared.keyWindow!.rootViewController = testVC
//                    _ = testVC.view
//
//                }
//
//                it("layout_cutoff diagnostic sent") {
//                    expect(errors.contains("[LAYOUT_CUTOFF]")).toEventually(beTrue(), timeout: .seconds(9))
//                }
//            })
//        }
    }
